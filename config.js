...
module.exports = {
    VERSION: 'v3.0.0',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/6npaxyb.jpeg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || 'karna;Skl11;0;https://i.imgur.com/6npaxyb.jpeg;https://chat.whatsapp.com/Bcm5xwr0orQE4p2HMYks3D',
    ...
    BOT_NAME: process.env.BOT_NAME || 'Karna',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? '🌲⃞⍣ꪶ᷁͢ꪶ͢⍣ʙʟ ᴠɪɴᴄᴇɴᴛ♪⍣͢ꫂ⍣⃞🌼;🙊🕊️ ⁱ ʰᵃᵛᵉ ᵃ ᵈᵃʳᵏ ᶠᵃᶜᵉ ..??🦋❤‍🩹;https://i.imgur.com/paTLqLv.jpeg' : process.env.AUDIO_DATA,
